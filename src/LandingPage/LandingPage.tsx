            ...
            <div className="section-about">
              <div className="section-about-content">
                <p>
                  ...
                  de coletar feedbacks dos alunos da Faculdade de Computação
                  sobre seus respectivos cursos. Entendemos que a experiência
                  acadêmica vai muito além das salas de aula e dos materiais
                  didáticos. Por isso, queremos ouvir diretamente dos alunos
